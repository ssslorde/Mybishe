<template>
	<div class="add-update-preview">
		<el-form
			...
			label-width="180px"
			>
			<el-form-item class="add-item" label="提交编号" prop="tijiaobianhao">
				<el-input v-model="ruleForm.tijiaobianhao" placeholder="提交编号" disabled></el-input>
			</el-form-item>
			...
			<el-form-item class="add-item"  label="批改状态" prop="pigaizhuangtai">
			...
			async onSubmit() {
				...
				await this.$refs["ruleForm"].validate(async valid => {
					if(valid) {
						...
						await this.$http.post(`zuoyetijiao/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(async res => {
							if (res.data.code == 0) {
								this.$message({
									message: '操作成功',
									type: 'success',
