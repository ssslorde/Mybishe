	...
	<div>
		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				...
				<el-button class="list-add-btn" v-if="btnAuth('cankexinxi','新增')" type="primary" @click="add('/index/cankexinxiAdd')">
						...
						<div class="infoBox">
							...
							<div class="bottomInfo">
								...
								<div class="publisher_item">
									...
									<span class="text">{{item.xuehao}}</span>
								</div>
								<div class="view_item">
									<span class="icon iconfont "></span>
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				this.$http.get(`cankexinxi/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/cankexinxiDetail', query: params});
			},
