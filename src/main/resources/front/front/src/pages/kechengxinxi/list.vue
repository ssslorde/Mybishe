...
<script>
	export default {
		...
		async created() {
			...
			this.selectOptionsList.push({name:'教学程度',list:this.jiaoxuechengduOptions,tableName: 'jiaoxuechengdu',check: -1})
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				if (this.formSearch.jiaoxuechengdu != '') searchWhere.jiaoxuechengdu = this.formSearch.jiaoxuechengdu;
