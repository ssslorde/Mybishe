		...
		<template v-if="showFlag">
			...
			<div :style='{"width":"100%","padding":"0","fontSize":"14px","color":"#000"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='false' prop="zuoyetijiao" label="作业提交">
						<template slot-scope="scope">
							<el-button v-if="scope.row.zuoyetijiao" type="text" size="small" @click="download(scope.row.zuoyetijiao)">下载</el-button>
							<span v-else >无</span>
						</template>
					</el-table-column>
					<el-table-column :resizable='false' :sortable='true'  
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('zuoyetijiao','批改作业')" @click="chengjixinxiCrossAddOrUpdateHandler(scope.row,'cross','','','pigaizhuangtai','已审批','已审批,待审批'.split(',')[0])" type="success">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"40px"}'></span>
								批改作业
							</el-button>
