	...
	<div class="main-content" :style='{"padding":"20px 0","fontSize":"15px"}'>
		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 10px 20px"}' :inline="true" :model="searchForm">
				...
				<el-row :style='{"padding":"10px","background":"#fff","display":"block"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","color":"#fff","borderRadius":"0px","background":"rgb(94, 131, 180)","width":"auto","fontSize":"16px","height":"34px"}' type="success" @click="backClick()">返回</el-button>
				</el-row>
			...
			<div :style='{"width":"100%","padding":"0","fontSize":"14px","color":"#000"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='false' :sortable='true' prop="score" label="评分">
						<template slot-scope="scope">
							<el-rate
					...
					<el-table-column :resizable='false' :sortable='true' prop="istop" label="是否置顶">
						<template slot-scope="scope">
							<el-switch
