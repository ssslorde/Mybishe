<template>
	<div class="addEdit-block">
		...
		>
			<template >
				<el-form-item class="input" v-if="type!='info'" label="成绩编号" prop="chengjibianhao" >
					<el-input v-model="ruleForm.chengjibianhao" placeholder="成绩编号" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-else-if="ruleForm.chengjibianhao" label="成绩编号" prop="chengjibianhao" >
					<el-input v-model="ruleForm.chengjibianhao" placeholder="成绩编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="作业要求" prop="zuoyeyaoqiu" >
					<el-input v-model="ruleForm.zuoyeyaoqiu" placeholder="作业要求" clearable  :readonly="ro.zuoyeyaoqiu"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="作业要求" prop="zuoyeyaoqiu" >
					<el-input v-model="ruleForm.zuoyeyaoqiu" placeholder="作业要求" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="提交时间" prop="tijiaoshijian" >
					<el-input v-model="ruleForm.tijiaoshijian" placeholder="提交时间" clearable  :readonly="ro.tijiaoshijian"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="提交时间" prop="tijiaoshijian" >
				...
				<el-form-item class="input" v-if="type!='info'"  label="作业成绩" prop="zuoyechengji" >
					<el-input-number v-model="ruleForm.zuoyechengji" placeholder="作业成绩" :disabled="ro.zuoyechengji"></el-input-number>
				</el-form-item>
				<el-form-item v-else class="input" label="作业成绩" prop="zuoyechengji" >
					<el-input v-model="ruleForm.zuoyechengji" placeholder="作业成绩" readonly></el-input>
				</el-form-item>
			</template>
			<el-form-item class="textarea" v-if="type!='info'" label="批语" prop="piyu" >
				<el-input
			...
			<el-form-item v-else-if="ruleForm.piyu" label="批语" prop="piyu" >
				<span class="text">{{ruleForm.piyu}}</span>
			</el-form-item>
