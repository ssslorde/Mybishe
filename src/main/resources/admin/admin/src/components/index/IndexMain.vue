<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"20px 10px 0 216px","margin":"0","position":"relative","background":"#e2e2e2","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":"0 1px 6px rgba(0, 0, 0, .3)","padding":"0 20px 0","margin":"0 10px 0 10px","alignItems":"center","color":"#fff","display":"flex","justifyContent":"flex-end","background":"#2F3644","gap":"20px","width":"calc(100% - 20px)","fontSize":"16px","position":"inherit","zIndex":"1001","height":"100px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"20px 40px","margin":"20px 10px 0 10px","borderColor":"#3b6885","borderWidth":"0 0 0px 0","background":"#fff","width":"calc(100% - 20px)","fontSize":"16px","borderStyle":"solid"}' class="bread-crumbs"></bread-crumbs>
