...
public class ZuoyexinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,ZuoyexinxiEntity zuoyexinxi,
		...
		if(tableName.equals("jiaoshi")) {
			zuoyexinxi.setJiaoshizhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) throws IOException {
        java.nio.file.Path path = java.nio.file.Paths.get("value_zuoyexinxi_" + xColumnName + "_" + yColumnName + "_timeType.json");
        ...
        String tableName = request.getSession().getAttribute("tableName").toString();
            ...
            ew.eq("xuehao", (String)request.getSession().getAttribute("username"));
                        ...
                        List<Map<String, Object>> result = zuoyexinxiService.selectValue(params, ew);
    ...
    public R valueMul(@PathVariable("xColumnName") String xColumnName,@RequestParam String yColumnNameMul,HttpServletRequest request)  throws IOException {
        java.nio.file.Path path = java.nio.file.Paths.get("value_zuoyexinxi_" + xColumnName + "_" + yColumnNameMul + "_timeType.json");
        if(java.nio.file.Files.exists(path)) {
            String content = new String(java.nio.file.Files.readAllBytes(path), java.nio.charset.StandardCharsets.UTF_8);
            return R.ok().put("data", (new org.json.JSONArray(content)).toList());
        }else{
...
String tableName = request.getSession().getAttribute("tableName").toString();
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType,HttpServletRequest request) throws IOException {
        java.nio.file.Path path = java.nio.file.Paths.get("value_zuoyexinxi_" + xColumnName + "_" + yColumnName + "_"+timeStatType+".json");
        if(java.nio.file.Files.exists(path)) {
            String content = new String(java.nio.file.Files.readAllBytes(path), java.nio.charset.StandardCharsets.UTF_8);
            return R.ok().put("data", (new org.json.JSONArray(content)).toList());
        }else{
    ...
    String tableName = request.getSession().getAttribute("tableName").toString();
                ...
                ew.eq("xuehao", (String)request.getSession().getAttribute("username"));
                                                        ...
                                                        List<Map<String, Object>> result = zuoyexinxiService.selectTimeStatValue(params, ew);
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
            for(Map<String, Object> m : result) {
                for(String k : m.keySet()) {
                    if(m.get(k) instanceof Date) {
    ...
    {
        java.nio.file.Path path = java.nio.file.Paths.get("value_zuoyexinxi_" + xColumnName + "_" + yColumnNameMul + "_" + timeStatType + ".json");
        if (java.nio.file.Files.exists(path)) {
            String content = new String(java.nio.file.Files.readAllBytes(path), java.nio.charset.StandardCharsets.UTF_8);
            return R.ok().put("data", (new org.json.JSONArray(content)).toList());
        }else{
    ...
    public R group(@PathVariable("columnName") String columnName,HttpServletRequest request) throws IOException {
        java.nio.file.Path path = java.nio.file.Paths.get("group_zuoyexinxi_" + columnName + "_timeType.json");
        if(java.nio.file.Files.exists(path)){
            String content = new String(java.nio.file.Files.readAllBytes(path), java.nio.charset.StandardCharsets.UTF_8);
            return R.ok().put("data", (new org.json.JSONArray(content)).toList());
        }else{
...
String tableName = request.getSession().getAttribute("tableName").toString();
            ...
            ew.eq("xuehao", (String)request.getSession().getAttribute("username"));
                        ...
                        List<Map<String, Object>> result = zuoyexinxiService.selectGroup(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R count(@RequestParam Map<String, Object> params,ZuoyexinxiEntity zuoyexinxi, HttpServletRequest request){
        String tableName = request.getSession().getAttribute("tableName").toString();
        if(tableName.equals("jiaoshi")) {
            zuoyexinxi.setJiaoshizhanghao((String)request.getSession().getAttribute("username"));
        }
        ...
        EntityWrapper<ZuoyexinxiEntity> ew = new EntityWrapper<ZuoyexinxiEntity>();
        int count = zuoyexinxiService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, zuoyexinxi), params), params));
