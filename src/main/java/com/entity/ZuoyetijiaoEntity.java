...
public class ZuoyetijiaoEntity<T> implements Serializable {
	 ...
	 * 设置：提交编号
	 */
	public void setTijiaobianhao(String tijiaobianhao) {
		this.tijiaobianhao = tijiaobianhao;
	}
	/**
	 * 获取：提交编号
	 */
	public String getTijiaobianhao() {
		return tijiaobianhao;
	}
	/**
	 * 设置：课程名称
	 */
